...
from fastapi import FastAPI, Request, WebSocket, WebSocketDisconnect, Form, status, Response, WebSocketDisconnect
...
async def get_chat(request: Request):
    ...
    return templates.TemplateResponse('chat_test.html', {"request": request, "messages": messages, "members": members})

# image data saved like
# {username}:base64,{base64}
